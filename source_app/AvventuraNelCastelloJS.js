class Avventura extends AvventuraNelCastelloJSEngine{
	constructor(){
		...
		this.stanzeComuni = {
			...
			spaltiMura: {
				description: i18n.AvventuraNelCastelloJS.commonRooms.ramparts.description,
		...
		this.datiAvventura = {
			...
			stanze: {
				...
				// 02.PIAZZA D'ARMI
				piazzaArmi: {
					description: i18n.AvventuraNelCastelloJS.rooms.paradeGround.description,
					shortDescription: i18n.AvventuraNelCastelloJS.rooms.paradeGround.shortDescription,
					override: {
						verbs:{
							entra: {
				...
				atrioCastello:{
					description: i18n.AvventuraNelCastelloJS.rooms.atrium.description,
				...
				// 05.SALONE
				salone: {
					description: i18n.AvventuraNelCastelloJS.rooms.lounge.description,
				...
				// 06.CORRIDOIO
				corridoio:{
					description: i18n.AvventuraNelCastelloJS.rooms.hallway.description,
				...
				// 07.SALA DA PRANZO
				salaPranzo: {
					description: i18n.AvventuraNelCastelloJS.rooms.diningRoom.description,
				...
				entrataLabirinto: {
					...
					...{
						description: i18n.AvventuraNelCastelloJS.rooms.labyrinthEntrance.description,
				...
				catapulta:{
					description: i18n.AvventuraNelCastelloJS.rooms.catapultRoom.description,
				...
				cellaAlchimista: {
					description: i18n.AvventuraNelCastelloJS.rooms.alchemistCell.description,
				...
				// 56.SALA DI MUSICA
				salaMusica: {
					description: i18n.AvventuraNelCastelloJS.rooms.musicHall.description,
