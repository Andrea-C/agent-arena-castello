var i18n = {
	...
	AvventuraNelCastelloJS: {
		...
		sequences: {
			...
			rock:  [
				`Scendi dolcemente nella luce del giorno nascente. Sotto di te le scure acque del lago di Loch Ness. Il vento ti spinge verso il centro del lago. Prendi terra fortunosamente su un piccolo scoglio roccioso.`,
				`Mentre ripieghi il paracadute ti guardi attorno:`
			], 
			again: {
				string: [
